...
document.addEventListener('DOMContentLoaded', () => {
    ...
    searchBtn.addEventListener('click', async () => {
        ...
        try {
            ...
            // Mostra a seção de previsão e move ela para o header
            ...
            forecastContainer.appendChild(prevBtn);
            forecastContainer.appendChild(nextBtn);
            ...
            // Desabilitar o botão 'next' se for a última previsão
            updateNavButtons();
    ...
    function updateNavButtons() {
        ...
        const days = document.querySelectorAll('.forecast-day');
        const maxIndex = days.length - 1; // Última previsão
        nextBtn.disabled = currentIndex === maxIndex; // Desabilita o botão 'next' se estiver na última previsão
        prevBtn.disabled = currentIndex === 0; // Desabilita o botão 'prev' se estiver na primeira previsão
    }
});
